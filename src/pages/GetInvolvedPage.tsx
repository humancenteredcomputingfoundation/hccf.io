...
const GetInvolvedPage: React.FC = () => {
  useEffect(() => {
    ...
    /**
     * This reproduces the fallback behavior from
     * Zeffy's original embed code.
     */
    const showZeffyFallback = () => {
      document
        ...
        .forEach((element) => {
          ...
          element
            .querySelectorAll<HTMLIFrameElement>("iframe[data-zeffy-embed-src]")
            .forEach((iframe) => {
    ...
    /**
     * Don't add Zeffy's script multiple times
    ...
    /**
     * We intentionally don't remove the script on
     * component unmount because Zeffy's embed may
      ...
      <section className="gi-hero-section">
        <div className="section-container">
          <h1 className="gi-hero-title">
            Let's build the human-centered future{" "}
            <span className="title-bold" style={{ color: "#000000" }}>
              together
            </span>
          </h1>

          <p className="gi-hero-text">
            Whether you're a technology company, a nonprofit, a potential
            funder, or simply someone who believes technology should serve
      ...
      <section className="gi-reachout-section">
        <div className="gi-reachout-container">
          ...
          <p className="gi-reachout-text">
            We're a lean, mission-driven team. Every message is read by the
            people who built this organization. We welcome partnerships, grant
            inquiries, nonprofit support requests, and general expressions of
            solidarity.
          </p>
          ...
          <div className="gi-contact-info">
            ...
            <div className="gi-contact-item">
              ...
              <div className="gi-details">
                ...
                <a
                  href="mailto:contact@hccf.onmy.cloud"
                  className="gi-detail-value"
                >
                  contact@hccf.onmy.cloud
                </a>
              </div>
            </div>
          ...
          <div className="gi-ways-to-engage">
            ...
            <ul className="gi-social-list">
              ...
              <li>
                <a
                  href="https://www.linkedin.com/company/humancenteredcomputing/"
                  target="_blank"
              ...
              <li>
                <a
                  href="https://www.facebook.com/profile.php?id=61583647284804"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor">
              ...
              <li>
                <a
                  href="https://www.instagram.com/humancenteredcomputing/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <svg viewBox="0 0 24 24" fill="currentColor">
      ...
      <section className="gi-newsletter-section">
        <div className="section-container">
          <h2 className="gi-newsletter-title">
            Interested in following our progress and getting
            <br />
            a .self subdomain when they become available?
            <br />
          ...
          <div className="gi-form-card">
            ...
            <div className="gi-zeffy-form">
              <div
                data-zeffy-embed
                data-form-url="/en-US/embed/newsletter-form/sign-up-for-our-newsletter-3475"
              />
              ...
              <div data-zeffy-embed-fallback style={{ display: "none" }}>
                ...
                >
                  <iframe
                    ...
                    data-zeffy-embed-src="https://www.zeffy.com/en-US/embed/newsletter-form/sign-up-for-our-newsletter-3475"
