    ...
    <footer className="footer">
      <div className="section-container footer-content">
        ...
        <div className="social-links">
          ...
          <a href="https://x.com" target="_blank" rel="noopener noreferrer" aria-label="X.com" className="social-icon">
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
          ...
          <a href="https://discuss.example.org" target="_blank" rel="noopener noreferrer" aria-label="Discuss Forum" className="social-icon">
            <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
